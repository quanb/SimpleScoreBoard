...
{
	public class GameAddAttendeeAdapter : BaseAdapter<Player>
	{
		private readonly Activity _context;

		public GameAddAttendeeAdapter(Activity context)
		{
			_context = context;
		}
		...
		public override View GetView(int position, View convertView, ViewGroup parent)
		{
			...
			if (view == null)
				view = _context.LayoutInflater.Inflate(Resource.Layout.GameAddAttendeeItem, null);
